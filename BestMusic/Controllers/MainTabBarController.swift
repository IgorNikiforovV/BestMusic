...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        hostVC.tabBarItem.image = UIImage(named: "TabBar/Library")
        hostVC.tabBarItem.title = "Library"

        viewControllers = [
            hostVC,
            generateViewController(rootViewController: searchVC, image: "TabBar/Search", title: "Search"),
            //generateViewController(rootViewController: hostVC, image: "TabBar/Library", title: "Library"),
        ]
    }
    ...
    func minimizedTrackDetailController() {
        ...
        UIView.animate(withDuration: 0.5,
                       ...
                       animations: {
                        ...
                        self.tabBar.alpha = 1
                        self.trackDetailView.setMiniTrackView(1)
                        self.trackDetailView.setMaximizedStackView(0)
                       },
                       completion: nil)
    }
    ...
    func maximizedTrackDetailController(viewModel: SearchViewModel.Cell?) {
        ...
        UIView.animate(withDuration: 0.5,
                       ...
                       animations: {
                        self.view.layoutIfNeeded()
                        self.tabBar.alpha = 0
                        self.trackDetailView.setMiniTrackView(0)
                        self.trackDetailView.setMaximizedStackView(1)
                       },
                       completion: nil)
